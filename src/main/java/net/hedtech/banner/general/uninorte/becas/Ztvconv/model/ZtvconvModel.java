...
public class ZtvconvModel extends FormModel {
	
	public ZtvconvModel(ITask task, Hashtable parameters) {
	...
	public IDBBusinessObject getZtvconv() {
		return (IDBBusinessObject) getBusinessObject("ZTVCONV");
	}
